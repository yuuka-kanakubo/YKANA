...
inline const std::string ext_nameTLxeta="hydro_profiles_y_at0__tau_";
	...
	const std::string default_out_directory_name="dndeta_proton";
	...
	const std::string default_out_directory_name="Rt_spectra";
	...
	const std::string default_out_directory_name="Rt_yield";
	const double x_max = 10.0;
	const double x_min = 0.0;
	const double x_max_HI = 10.0;
	const double d_x = 0.5;
	...
	const std::string default_out_directory_name="cumulant_multi";
	...
	const std::string default_out_directory_name="cumulant_pt";
	const double x_max = 20.0;
	...
	const std::string default_out_directory_name="cumulant_eta";
	const double x_max = 10.0;
	const double x_max_HI = 10.0;
	...
	const std::string default_out_directory_name="mtscaling";
	...
	const std::string default_out_directory_name="twopc2D";
	...
	const std::string default_out_directory_name="twopc1D";
	...
	const std::string default_out_directory_name="twopcInteg";
	...
	const std::string default_out_directory_name="meanmt";
	...
	const std::string default_out_directory_name="meanpt";
	const double x_max = 150.0;
	const double x_max_HI = 1500.0;
	const double x_min = 0.0;
	const double d_x = 5.0;
	...
	const std::string default_out_directory_name="MeanptPID";
	const double x_max = 150.0;
	const double x_max_HI = 1500.0;
	const double x_min = 0.0;
	const double d_x = 5.0;
	...
	const std::string default_out_directory_name="timelapse";
	...
	const std::string default_out_directory_name="vertices";
	const double x_max = 20.0;
	const double x_min = -20.0;
	const double d_x = 0.5;
	const double d_x_HI = 0.5;
	...
	const std::string default_out_directory_name="readXY";
	const double x_max = 10.0;
	const double x_min = -10.0;
	...
	const int x_cell_capa=1000;
	const std::string default_ext="/jetinfo.txt";
	const double y_max = 0.0;
	const double y_max_HI = 0.0;
	const double y_min = 0.0;
	const double d_y = 0.0;
	...
	const double d_x = 0.5;
	const double d_x_HI = 0.1;
	const int x_cell_capa=3000;
	const std::string default_ext="/hadronised.txt";
	const double y_max = 1.0;
	const double y_max_HI = 0.0;
	const double y_min = -1.0;
	const double d_y = 0.1;
	const double d_y_HI = 0.0;
	const int y_cell_capa=0;
#else
...
inline	const std::string default_inputfname = "input";
inline	const std::string default_out_fname="hist.txt";
inline  const std::string seed_outputfname="SEED.txt";
inline	const int default_nfiles=10000;
inline	const std::vector<std::string> save_settings_fname={"include/Constants.h"};
